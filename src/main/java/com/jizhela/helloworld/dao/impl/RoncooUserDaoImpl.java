 ...
 */
@Repository
//repository是代表是持久层的注解
//用jdbctemplate还是用jpa,都在于这个DAO类extends了什么，这里extends了JdbcDaoImpl，所以用的是jdbctemplate
